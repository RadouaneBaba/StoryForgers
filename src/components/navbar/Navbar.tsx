...
export default async function Navbar() {
  ...
  return (
    <nav className="p-5 shadow bg-slate-900 md:flex md:items-center md:justify-between">
      {/* Logo and project name */}
      <div className="flex justify-between items-center mx-2">
        <span className="text-2xl pl-5 md:pl-0 font-semibold text-slate-50l font-[Poppins] cursor-pointer">
          <Image width={60} height={60} className=" h-12 inline mr-1" src="/images/hero33.svg" alt="StoryForgers Logo"/>
